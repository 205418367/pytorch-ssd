...
class _Net(object):
    ...
    def add_layer(self,layer_params,bottom=''):
        index = -1
        if bottom != '':
            index = self.layer_index(bottom) + 1
        ...
        if index != -1:
            ...
            #self.net.layer.insert(index,new_layer)
        else:
...
class Caffemodel(_Net):
    ...
    def add_layer_with_data(self,layer_params,datas,bottom):
        self.add_layer(layer_params,bottom)
